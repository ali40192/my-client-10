...
const AboutBookhaven = () => {
  return (
    <div className="  bg-[#F0E491] shadow-lg border rounded-2xl p-8 text-center">
      <h2 className="text-3xl font-bold text-[#BBC863] mb-4">
        About The<span className="text-[#31694E]"> Book Haven</span>
      </h2>
      ...
      <p className="text-[#31694E] leading-relaxed mb-8">
